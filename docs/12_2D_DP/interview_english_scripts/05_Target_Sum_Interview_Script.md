...
| We solve Target Sum. | 我們要解這一題。 | Restatement |
| Input and output follow the source statement. | 輸入輸出依來源敘述。 | Restatement |
| I will use DP (Subset Sum Optimization) as main method. | 我會用來源主方法。 | Restatement |
...
| English line | Traditional Chinese meaning (short) | Interview stage |
|---|---|---|
| Optimized method uses DP (Subset Sum Optimization). | 優化法使用來源主方法。 | Approach |
...
| Sample input: nums = [1,1,1,1,1], target = 3. | 範例輸入：nums = [1,1,1,1,1], target = 3。 | Dry-run |
