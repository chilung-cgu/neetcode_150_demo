...
| We solve Gas Station. | 我們要解這一題。 | Restatement |
| Input and output follow the source statement. | 輸入輸出依來源敘述。 | Restatement |
| I will use Greedy (One Pass) as main method. | 我會用來源主方法。 | Restatement |
...
| English line | Traditional Chinese meaning (short) | Interview stage |
|---|---|---|
| Optimized method uses Greedy (One Pass). | 優化法使用來源主方法。 | Approach |
...
| Sample input: gas = [1,2,3,4,5], cost = [3,4,5,1,2]. | 範例輸入：gas = [1,2,3,4,5], cost = [3,4,5,1,2]。 | Dry-run |
