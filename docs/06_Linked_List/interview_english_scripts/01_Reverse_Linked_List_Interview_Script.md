...
| We solve Reverse Linked List. | 我們要解這一題。 | Restatement |
...
| Sample input: head = [1,2,3,4,5]. | 範例輸入：head = [1,2,3,4,5]。 | Dry-run |
...
| Expected output: [5,4,3,2,1]. | 預期輸出：[5,4,3,2,1]。 | Dry-run |
