---
title: "Subsets II (子集 II)"
description: "題目給一個**可能包含重複數字**的整數陣列 `nums`。 回傳所有可能的 **唯一** 子集 (Power Set)。 解集 **不能包含重複的子集**。"
tags:
  - 
...
> 📌 **LeetCode #90** — [題目連結](https://leetcode.com/problems/subsets-ii/) | [NeetCode 解說](https://neetcode.io/problems/subsets-ii)
