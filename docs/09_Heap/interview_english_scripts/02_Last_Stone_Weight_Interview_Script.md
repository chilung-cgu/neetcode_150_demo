...
| We solve Last Stone Weight. | 我們要解這一題。 | Restatement |
| Input and output follow the source statement. | 輸入輸出依來源敘述。 | Restatement |
| I will use Max-Heap as main method. | 我會用來源主方法。 | Restatement |
...
| English line | Traditional Chinese meaning (short) | Interview stage |
|---|---|---|
| Optimized method uses Max-Heap. | 優化法使用來源主方法。 | Approach |
...
| Sample input: stones = [2,7,4,1,8,1]. | 範例輸入：stones = [2,7,4,1,8,1]。 | Dry-run |
