...
| We solve Evaluate Reverse Polish Notation. | 我們要解這一題。 | Restatement |
...
| Then, I combine postfix state for right-side contribution. | 依來源步驟執行。 | Coding |
...
| Sample input: ["2","1","+","3","*"]. | 範例輸入：["2","1","+","3","*"]。 | Dry-run |
