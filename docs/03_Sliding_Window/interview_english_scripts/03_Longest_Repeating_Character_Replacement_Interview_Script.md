...
| We solve Longest Repeating Character Replacement. | 我們要解這一題。 | Restatement |
| Input and output follow the source statement. | 輸入輸出依來源敘述。 | Restatement |
| I will use Sliding Window as main method. | 我會用來源主方法。 | Restatement |
...
| English line | Traditional Chinese meaning (short) | Interview stage |
|---|---|---|
| Optimized method uses Sliding Window. | 優化法使用來源主方法。 | Approach |
...
| Sample input: s = "ABAB", k = 2. | 範例輸入：s = "ABAB", k = 2。 | Dry-run |
