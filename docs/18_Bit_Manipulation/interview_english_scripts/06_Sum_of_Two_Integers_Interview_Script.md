...
| We solve Sum of Two Integers. | 我們要解這一題。 | Restatement |
| Input and output follow the source statement. | 輸入輸出依來源敘述。 | Restatement |
| I will use Bit Manipulation as main method. | 我會用來源主方法。 | Restatement |
...
| English line | Traditional Chinese meaning (short) | Interview stage |
|---|---|---|
| Optimized method uses Bit Manipulation. | 優化法使用來源主方法。 | Approach |
...
| Sample input: a = 1, b = 2. | 範例輸入：a = 1, b = 2。 | Dry-run |
