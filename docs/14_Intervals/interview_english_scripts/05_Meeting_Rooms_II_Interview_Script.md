...
| We solve Meeting Rooms II. | 我們要解這一題。 | Restatement |
| Input and output follow the source statement. | 輸入輸出依來源敘述。 | Restatement |
| I will use Chronological Ordering as main method. | 我會用來源主方法。 | Restatement |
...
| Brute space is about O(Range) from source. | 來源暴力空間約 O(Range)。 | Approach |

### Optimized approach (5 lines)

| English line | Traditional Chinese meaning (short) | Interview stage |
|---|---|---|
| Optimized method uses Chronological Ordering. | 優化法使用來源主方法。 | Approach |
